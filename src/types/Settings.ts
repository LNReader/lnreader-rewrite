...
export enum Setting {
   ...
   * Update Settings
   */
  SKIP_UPDATING_NOVELS_WITH_UNREAD_CHAPTERS = 'SKIP_UPDATING_NOVELS_WITH_UNREAD_CHAPTERS',
  SKIP_UPDATING_NOVELS_NOT_STARTED = 'SKIP_UPDATING_NOVELS_NOT_STARTED',
  SKIP_UPDATING_COMPLETED_NOVELS = 'SKIP_UPDATING_COMPLETED_NOVELS',
  UPDATES_INCLUDED_CATEGORIES = 'UPDATES_INCLUDED_CATEGORIES',
  UPDATES_EXCLUDED_CATEGORIES = 'UPDATES_EXCLUDED_CATEGORIES',
  REFRESH_METADATA_ON_UPDATE = 'REFRESH_METADATA_ON_UPDATE',
  ...
  ONLY_INCLUDE_PINNED_SOURCES = 'ONLY_INCLUDE_PINNED_SOURCES',
...
export interface SettingTypes {
  ...
  [Setting.SKIP_UPDATING_NOVELS_WITH_UNREAD_CHAPTERS]: boolean;
  [Setting.SKIP_UPDATING_NOVELS_NOT_STARTED]: boolean;
  [Setting.SKIP_UPDATING_COMPLETED_NOVELS]: boolean;
  [Setting.UPDATES_INCLUDED_CATEGORIES]: number[];
  [Setting.UPDATES_EXCLUDED_CATEGORIES]: number[];
  [Setting.REFRESH_METADATA_ON_UPDATE]: boolean;
  [Setting.LAST_UPDATE_TIME]: number;
  ...
  [Setting.KEEP_SCREEN_ON]: boolean;
  ...
  [Setting.ONLY_INCLUDE_PINNED_SOURCES]: boolean;
}
